...
begin
  ...
  case $FF AND aaa.ram[$FF AND aaa.regs[IP]].opHex of
    ...
    $D5 : aaa.imovRR;   { MOV  AL,BL }
                                            //1111111111111111111111111
    $D6 : aaa.imovRMxp; { MOV  AL,[BL+02] }   //Cookie
    $D7 : aaa.imovRMxm; { MOV  AL,[BL-02] }   //Cookie
    $D8 : aaa.imovMxpR; { MOV  [AL+02],BL }   //Cookie
    $D9 : aaa.imovMxmR; { MOV  [AL-02],BL }   //Cookie
                                        //2222222222222222222222222
    $DD : aaa.imovPP;   { MOV  SP,BP   }   // -----------------------------------------
